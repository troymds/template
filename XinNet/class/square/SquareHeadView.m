...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _iconImg.center = CGPointMake(kWidth/2,20+_iconImg.frame.size.height/2);
        [self addSubview:_iconImg];
        
        //用户名
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(0,_iconImg.frame.origin.y+_iconImg.frame.size.height+5, kWidth,30)];
