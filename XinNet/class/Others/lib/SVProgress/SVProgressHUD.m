...
- (void)setStatus:(NSString *)string {
    ...
    if(string) {
        ...
        if ([[UIDevice currentDevice].systemVersion floatValue]>=7.0) {
            ...
            stringSize = [string boundingRectWithSize:CGSizeMake(200, 300) options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:dic context:nil].size;
        } else {
